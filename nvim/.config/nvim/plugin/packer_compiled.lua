...
_G.packer_plugins = {
  ...
  ["cmp-nvim-lua"] = {
    after_files = { "/Users/b/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lua/after/plugin/cmp_nvim_lua.lua" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/Users/b/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lua",
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'cmp-nvim-lua', 'nvim-colorizer.lua'}, { ft = "lua" }, _G.packer_plugins)]]
