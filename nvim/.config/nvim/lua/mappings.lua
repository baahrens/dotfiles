...
wk.add({
  ...
  { "<leader>g", group = "git" },
  {
    "<leader>gs",
    function()
      require("plugin/fugitive").status()
    end,
    desc = "Status",
  },
  {
  ...
  { "<leader>gr", vim_cmd("Git reset HEAD^"), desc = "Reset HEAD^" },
  {
    "<leader>gR",
    function()
      require("plugin/fugitive").reset_hard()
    end,
    desc = "Reset hard master",
  },
  {
    "<leader>gn",
    function()
      require("plugin/fugitive").new_branch()
    end,
  ...
  { "K", vim.lsp.buf.hover },
  {
    "<C-f>",
    function()
      require("conform").format({ bufnr = 0, quiet = true })
    end,
    mode = { "n", "v" },
  },

  { "<leader>s", group = "settings" },
  { "<leader>sf", settings.toggle_format_on_save, desc = "Toggle on save formatting" },
  { "<leader>sp", settings.toggle_format_prettier, desc = "Toggle prettier formatting" },
  { "<leader>se", settings.toggle_format_eslint, desc = "Toggle eslint formatting" },
  { "<leader>su", settings.toggle_diagnostic_underline, desc = "Toggle diagnostic underline" },
  { "<leader>sv", settings.toggle_diagnostic_virtual, desc = "Toggle diagnostic virtual" },
  { "<leader>sc", settings.toggle_colorcode_highlights, desc = "Toggle colorcode highlights" },
